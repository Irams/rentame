<?php include_once 'includes/templates/header.php';?>
	<div id="fh5co-main">
		...
		<div class="fh5co-narrow-content">
			...
			<div class="row animate-box" data-animate-effect="fadeInLeft">
				<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
						<a href="#testimonial">
							...
							<!-- <h3 class="fh5co-work-title">Vibrocompactador</h3>
							<p>Marca Raygo con tambor de 84"</p> -->
						</a>
				</div>
				<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
						<a href="#testimonial">
			...
			<div id="testimonial" class="fh5co-testimonial" >
				<div class="fh5co-narrow-content">
					<div class="owl-carousel-fullwidth animate-box" data-animate-effect="fadeInLeft">
		            <div class="item">
		            	<figure>
		            		<img src="images/whatsapp-brands.svg" alt="Whatsapp">
		            	</figure>
		              	<p class="text-center quote"><!--&ldquo;-->Escríbenos o llámanos al<br> 722 331-71-53 con David García<!--<br> o al 722 491-55-64 con Eduardo Cuéllar &rdquo; <cite class="author">&mdash; Ferdinand A. Porsche</cite>--></p>
		            </div>
		            <div class="item">
		            	<figure>
		            		<img src="images/envelope-solid.svg" alt="Correo">
		            	</figure>
		              	<p class="text-center quote"><!--&ldquo;-->Mándanos un correo a david@ingenieriaintegral.com.mx<!--<br> o a eduardo@ingenieriaintegral.com.mx&rdquo; <cite class="author">&mdash; Ferdinand A. Porsche</cite>--></p>
		            </div>
		            <div class="item">
		            	<figure>
		            		<img src="images/link-solid.svg" alt="Ingeniería Integral">
		            	</figure>
		              	<p class="text-center quote"><!--&ldquo;-->Visítanos en: <a class="iia" href="http://187.216.191.85/iias/">ingenieriaintegral.com.mx</a><!--&rdquo;<cite class="author">&mdash; Frank Chimero</cite>--></p>
		            </div>
		          </div>
				</div>
			</div>
